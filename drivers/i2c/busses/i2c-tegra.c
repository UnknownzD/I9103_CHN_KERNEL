...
#define I2C_CMD_ADDR0_				0x004
#define I2C_CMD_ADDR1_				0x008
#define I2C_CMD_DATA1_				0x00c
#define I2C_CMD_DATA2_				0x010
...
err:
	...
	dev_warn(i2c_dev->dev, "FIFO_STATUS: 0x%08x, FIFO_CONTROL: 0x%08x\n",
		 i2c_readl(i2c_dev, I2C_FIFO_STATUS),
		 i2c_readl(i2c_dev, I2C_FIFO_CONTROL));

	dev_warn(i2c_dev->dev, "CMD_ADDR: 0x%08x, 0x%08x CMD_DATA: 0x%08x, 0x%08x\n",
		 i2c_readl(i2c_dev, I2C_CMD_ADDR0_),
		 i2c_readl(i2c_dev, I2C_CMD_ADDR1_),
		 i2c_readl(i2c_dev, I2C_CMD_DATA1_),
		 i2c_readl(i2c_dev, I2C_CMD_DATA2_));

	dev_warn(i2c_dev->dev, "packet: 0x%08x %u 0x%08x\n",
	...
	struct i2c_msg *msg, int stop)
{
	...
	if (i2c_dev->msg_err == I2C_ERR_NO_ACK) {
		if (msg->flags & I2C_M_IGNORE_NAK) {
			pr_err("[I2C-TEMP] I2C_M_IGNORE_NAK\n");
			return 0;
		}
		return -EAGAIN;
	}
